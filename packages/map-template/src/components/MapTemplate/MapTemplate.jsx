 ...
 * @param {string} [props.center] - Specifies the coordinates (latitude, longitude) for centering the map, e.g., center=9.9,57.05. If the provided coordinates intersect with a Venue, that Venue will automatically be selected in the Venue Selector. This also allows to search for map elements within the selected Venue.
 */
