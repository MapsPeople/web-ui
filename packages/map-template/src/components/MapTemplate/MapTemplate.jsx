...
function MapTemplate({ apiKey, gmApiKey, mapboxAccessToken, venue, locationId, primaryColor, logo, appUserRoles, directionsFrom, directionsTo, externalIDs, tileStyle, startZoomLevel, bearing, pitch, gmMapId, useMapProviderModule, kioskOriginLocationId, language, supportsUrlParameters, useKeyboard, timeout, miTransitionLevel, category, searchAllVenues, hideNonMatches, showRoadNames, showExternalIDs }) {
    ...
    function initializeMapsIndoorsSDK() {
        return new Promise((resolve) => {
            ...
            miSdkApiTag.setAttribute('src', 'https://app.mapsindoors.com/mapsindoors/js/sdk/CandidateReleases/2024.09.11-rc9/mapsindoors-2024.9.11-rc9.js.gz');
            miSdkApiTag.setAttribute('integrity', 'sha384-6bsPKx+zk38xfO5uN5D4MR8lTg0xIzzE8WtGyxgXH0M/ZriqklrAe+SJmbJpIOLz');

            // miSdkApiTag.setAttribute('integrity', 'sha384-yyJTDgfl1RAf4ZLN09SEzNyzyo+uZgLDkMwbYCV24ifBpLFAxV3Iod+8pgPDSd0a');
