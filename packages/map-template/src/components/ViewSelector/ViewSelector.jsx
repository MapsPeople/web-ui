...
import ViewSelectorIcon from '../../assets/view-selector.svg?react';
...
function ViewSelector({ isViewSelectorDisabled, isViewSelectorVisible }) {
     ...
     */
    const ToggleButton = () => (
        <button ref={toggleButtonRef} className="view-selector__toggle-button" onClick={() => setIsExpanded(!isExpanded)} disabled={isViewSelectorDisabled} aria-label={t('Toggle view selector')}>
            <ViewSelectorIcon />
        </button>
    );
