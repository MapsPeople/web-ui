...
| `floorSelectorControlPosition` | `floor-selector-control-position` | Render the floor selector as a Map Control at the given position.                                                                                                                                                                                                                                                                                             | `ControlPosition.BOTTOM_CENTER \| ControlPosition.BOTTOM_LEFT \| ControlPosition.BOTTOM_RIGHT \| ControlPosition.LEFT_BOTTOM \| ControlPosition.LEFT_CENTER \| ControlPosition.LEFT_TOP \| ControlPosition.RIGHT_BOTTOM \| ControlPosition.RIGHT_CENTER \| ControlPosition.RIGHT_TOP \| ControlPosition.TOP_CENTER \| ControlPosition.TOP_LEFT \| ControlPosition.TOP_RIGHT` | `undefined`                                                                                                                                          |
...
| `myPositionControlPosition`    | `my-position-control-position`    | Render the My Position Control as a Map Control at the given position.                                                                                                                                                                                                                                                                                        | `ControlPosition.BOTTOM_CENTER \| ControlPosition.BOTTOM_LEFT \| ControlPosition.BOTTOM_RIGHT \| ControlPosition.LEFT_BOTTOM \| ControlPosition.LEFT_CENTER \| ControlPosition.LEFT_TOP \| ControlPosition.RIGHT_BOTTOM \| ControlPosition.RIGHT_CENTER \| ControlPosition.RIGHT_TOP \| ControlPosition.TOP_CENTER \| ControlPosition.TOP_LEFT \| ControlPosition.TOP_RIGHT` | `undefined`                                                                                                                                          |
