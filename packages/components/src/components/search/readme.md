...
| `isChatModeEnabled` | `is-chat-mode-enabled` | Whether chat mode is enabled. When true, disables debounce for immediate input handling.                                                                                                                                                                              | `boolean`                    | `false`                                            |
...
| `showClearButton`   | `show-clear-button`    | Whether to show the clear button. Defaults to true.                                                                                                                                                                                                                   | `boolean`                    | `true`                                             |
