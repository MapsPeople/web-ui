...
| `buildingsOpacity`             | `buildings-opacity`               | Opacity of Mapbox Standard extruded buildings (0-1).                                                                                                                                                                                                                                                                                                          | `number`                                                                                                        | `0`                                                                                                                                                 |
...
| `minZoom`                      | `min-zoom`                        | The minimum zoom level of the map.                                                                                                                                                                                                                                                                                                                            | `number`                                                                                                        | `15`                                                                                                                                                |
...
| `showMapMarkers`               | `show-map-markers`                | Specifies if the Mapbox basemap point-of-interest, transit, and place labels are shown.                                                                                                                                                                                                                                                                       | `boolean`                                                                                                       | `false`                                                                                                                                             |
